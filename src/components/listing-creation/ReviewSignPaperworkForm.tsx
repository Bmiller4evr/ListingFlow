...
import { ArrowLeft, ArrowRight, FileSignature, Check, Clock, User, Calendar, FileText, Shield, Pen, X, Users } from "lucide-react";

interface ReviewSignPaperworkData {
...
interface ReviewSignPaperworkFormProps {
  onNext: (data: ReviewSignPaperworkData) => void;
  onBack?: () => void;
  onExit?: () => void;
  initialData?: Partial<ReviewSignPaperworkData>;
}

export function ReviewSignPaperworkForm({ onNext, onBack, onExit, initialData }: ReviewSignPaperworkFormProps) {
  const [formData, setFormData] = useState<ReviewSignPaperworkData>({
